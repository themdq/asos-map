...
export default function WeatherCard({
  ...
  if (loading) {
    return (
      <div className="w-full">
        <div className="bg-brand-50 border border-gray-200 rounded-[5px] p-8 shadow-lg">
  ...
  return (
    <div className="w-full max-h-[70vh] overflow-y-auto">
      <div className="bg-primary border border-gray-200 rounded-[5px] shadow-lg text-gray-800 p-6">
        {/* Заголовок */}
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          {/* Ветер */}
          <div className="rounded-[5px] bg-secondary-foreground p-3.5 border border-gray-200">
        ...
        {/* Временная шкала */}
        <div className="rounded-[5px] bg-secondary-foreground p-3.5 border border-gray-200 mb-3">
